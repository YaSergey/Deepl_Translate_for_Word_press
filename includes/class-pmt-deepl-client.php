...
class PMT_DeepL_Translation_Provider implements PMT_Translation_Provider_Interface
{
    ...
    public function translate_text($text, $target_language, $source_language = null, $extra_args = array())
    {
        ...
        $style_args = apply_filters('pmt_deepl_style_args', array(), $text, $target_language, $source_language);
        ...
        if ($status_code !== 200) {
            ...
            return new WP_Error('deepl_api_error', sprintf(__('Ошибка DeepL: %s', 'polylang-mass-translation-deepl'), $response_body));
        }
        ...
        if (!isset($data['translations'][0]['text'])) {
            ...
            return new WP_Error('deepl_bad_response', __('Некорректный ответ DeepL.', 'polylang-mass-translation-deepl'));
        }
